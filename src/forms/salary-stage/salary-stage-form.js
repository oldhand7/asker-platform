...
const SalaryStageForm = ({ className, values, onValues }) => {
  ...
  return <div className={classNames(styles['salary-stage-form'], className)}>
    ...
    <TextInputField error={errors && errors.currency} className={styles['salary-stage-form-field']} onChange={control.input('currency')} name="currency" value={formValues.currency} />
