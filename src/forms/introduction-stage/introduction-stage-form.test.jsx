...
import IntroductionStageForm from './introduction-stage-form'

describe('introduction-stage-form', () => {
    it('should allow for stage text and time edit', () => {
        ...
        const {
            ...
            container,
            getByText
        } = render(<IntroductionStageForm test={1} onError={onError} values={{ html: 'Some text!', time: 12 }} onValues={onValues} />)

        expect(container).toHaveTextContent('Introduction')
        ...
        const input = getByPlaceholderText('Enter your introduction text')
