...
const CompanyPresentationStageForm = ({ values, className, onValues, onError }) => {
  ...
  return <div className={classNames(className, styles['company-presentation-stage-form'])}>
    <TextareaInputField error={errors && errors['notes']} className={classNames(styles['company-presentation-stage-form-field'], styles['company-presentation-stage-form-notes'])} name="notes" onChange={control.input('notes')} placeholder="Enter your introductory text" />
