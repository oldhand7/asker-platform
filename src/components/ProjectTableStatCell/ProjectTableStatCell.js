...
const ProjectTableStatCell = ({ project, className }) => {
  return <div className={classNames(styles['project-table-stat-cell'], className)}>
    <div>
      <span className={styles['project-table-stat-cell-count']}>{project.interviewsCount || 0} </span>
       Number of candidates
    </div>
    <div className={styles['project-table-stat-cell-status']}>
      <span className={styles['project-table-stat-cell-count']}>{project.interviewsAwaitingCount || 0} </span>
    ...
    <div className={classNames(
      ...
      <span className={styles['project-table-stat-cell-count']}>{project.interviewsCount - project.interviewsAwaitingCount || 0} </span>
